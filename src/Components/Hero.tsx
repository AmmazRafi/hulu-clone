...
export default function Hero() {
    ...
    const getPopularMovies=()=>{
          GlobalApi.getPopularMovies.then((resp:any)=>{
            ...
            const randomMum = Math.floor(Math.random()*10)
            setMovieList(result[randomMum])
        })
    }
    return (
    <div>
        ...
        px-10 md:px-24'>
            ...
            <div className='flex gap-5 mt-5'>
                ...
                <button className='bg-transparent border-2
                 border-white text-white cursor-pointer hover:border-gray-500'>DETAILS</button>
            </div>
        </div>
      <img src={IMAGE_BASE_URL+movieList.poster_path} width={1920} height={1080}
